                ...
                <div className="container bg-dark">
                    <div className="d-flex row mb-5 ">
                        <div className="col mt-4">
                            <img 
                                src={!imageError ? `https://starwars-visualguide.com/assets/img/starships/${params.id}.jpg` : "https://starwars-visualguide.com/assets/img/placeholder.jpg"}
                        ...
                        <div className="col">
                            <h2 className="text-center text-warning fw-bold mt-4">{store.StarshipDetail.name}</h2>
                    ...
                    <div className="container mt-5">
                        <div className="d-flex justify-content-between row">
                            ...
                            <div className="col">
                                <p className="text-warning fw-bold text-center">Starship Class</p>
